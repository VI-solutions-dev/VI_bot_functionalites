...
class ControlBot:
    ...
    def move2goal(self):
        ...
        while not rospy.is_shutdown() and abs(self.steering_angle(goal_pose) - self.pose.theta) >= angle_tolerance:
        
              velocidad_angular = self.angular_vel(goal_pose,constant=3) #---------------------------------------------------------------------
              
              print("-------------------------------------------------------")
              print("Accion: girando..")
