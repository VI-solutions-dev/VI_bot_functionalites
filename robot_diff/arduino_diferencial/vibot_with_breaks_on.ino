...
/* ==== PWM limits ==================================================== */
const int MIN_PWM = 60;   // lower edge of usable duty-cycle
const int MAX_PWM = 80;   // upper edge of usable duty-cycle
...
void velCallback(const geometry_msgs::Twist &msg)
{
  ...
  double w = constrain(msg.angular.z, -MAX_ANGULAR_VEL,MAX_ANGULAR_VEL);
